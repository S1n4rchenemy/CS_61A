...
class ScubaThrower(ThrowerAnt):
    """ScubaThrower is a special sub-species of ThrowerAnt and has the ability of living in the water.  However, it also 
    has much higher food_cost.
    """
    name = 'Scuba'
    food_cost = 6
    is_watersafe = True
...
# END Problem EC
    ...
    def __init__(self, armor=1):
        ...
        self.number = QueenAnt.queen_number
...
class NinjaAnt(Ant):
    ...
    def action(self, gamestate):
        ...
        for bee in temp_bees_list:
                bee_index = curr_place.bees.index(bee)
                curr_place.bees[bee_index].reduce_armor(self.damage)
        # END Problem Optional 1
...
class BodyguardAnt(ContainerAnt):
    ...
    def __init__(self, *args, armor=2):
        ContainerAnt.__init__(self, *args, armor)
    # END Optional 2
