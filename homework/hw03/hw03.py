...
def replace_leaf(t, find_value, replace_value):
    ...
    if is_leaf(t):
        ...
        new_branches = [replace_leaf(branches(t)[i], find_value, replace_value) for i in range(len(branches(t)))]
...
def preorder(t):
    ...
    if is_leaf(t):
        ...
        labels_extracted = [label(t)]
        for i in range(len(branches(t))):
            labels_extracted = labels_extracted + preorder(branches(t)[i])
        return labels_extracted
...
def has_path(t, word):
    ...
    if len(word) == 1:
        ...
        judge = False
        for i in range(len(branches(t))):
            judge = has_path(branches(t)[i], word[1:]) or judge 
        return True and judge 
    else:
        return False  
